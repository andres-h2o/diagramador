        ...
        .on('value',function (snapshot) {
            ...
            snapshot.forEach(function (e) {
                ...
                if(nombre==user){
                    ...
                    html+='<li class="sent"><img src="http://emilcarlsson.se/assets/mikeross.png" alt="" /><p>'+nombre+': '+ mensaje+ '</p></li>';

                }else{
                    html+='<li class="replies"><img src="http://emilcarlsson.se/assets/mikeross.png" alt="" /><p>'+nombre+': '+ mensaje+ '</p></li>';
                }
